...
def vertical_towers_weight(lowest_pressure, highest_temp, diameter, tangent_tangent_length, material_density):
    """
    Calculate the weight of a vertical chemical processing tower based on provided parameters of pressure, temperature, dimensions, and material density.
